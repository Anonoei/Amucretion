...
export class Amucretion {
    ...
    public constructor() {
        ...
        if (location.pathname.endsWith("index.html")) {
            ...
            this.url = "https://daavllc.github.io/Amucretion";
        }
    }

    public Initialize(ui: UI, path: string): void {
        this.log.trace("Initializing...");
        this.ui = ui;
        let tPath = "";
        for (
            let i = 0;
            i < location.pathname.length - (path + this.file).length;
            i++
        )
            tPath += location.pathname.charAt(i);
        this.path = location.origin + tPath;
        this.ui.Initialize();
    }
    ...
    public Render(): void {
        ...
        this.root.render(
            <div id="containerAmucretion">
                <this.Title name={this.ui.Name} version={this.ui.Version} />
                <this.Body game={this.ui.Render()} />
    ...
    public get UI(): UI {
        if (this.ui == null) throw new Error("UI is null!");
        return this.ui;
    }
    ...
    private Title(props: any): JSX.Element {
        return (
            <div id="containerTitle">
                <title>Amucretion | {props.name}</title>
    ...
    private Footer(props: any): JSX.Element {
        return (
            <div id="containerFooter">
                <div id="containerFooter_Name">Amucretion</div>
